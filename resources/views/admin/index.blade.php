                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <span class="txt-light block counter"><span class="counter-anim">30025</span></span>
                                        <span class="weight-500 uppercase-font txt-light block font-13">Total Users</span>
                                    </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        ...
                                        <span class="weight-500 uppercase-font txt-light block">Agencies</span>
                                    </div>
                                    <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                        <i class="icon-layers txt-light data-right-rep-icon"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row">
            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Booking Statistics</h6>
                    </div>
